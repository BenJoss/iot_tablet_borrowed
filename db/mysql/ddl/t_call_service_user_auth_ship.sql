...
-- ----------------------------
-- Table structure for t_call_service_user_auth_ship
-- ----------------------------
DROP TABLE IF EXISTS `t_call_service_user_auth_ship`;
CREATE TABLE `t_call_service_user_auth_ship`  (
   ...
   KEY USER_AUTH_KEY (USER_ID,AUTH_CODE)
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '呼叫服务用户权限关系表';
