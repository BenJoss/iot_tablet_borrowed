...
-- ----------------------------
-- Table structure for t_iot_config
-- ----------------------------
DROP TABLE IF EXISTS `t_iot_config`;
CREATE TABLE `t_iot_config`  (
   `ID` bigint(16) AUTO_INCREMENT NOT NULL COMMENT '自增ID',
   `CON_VALUE` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '配置顺序值',
   `CON_TYPE` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '配置类型 1:楼层 2:地址',
   `CON_ORDER` int NULL COMMENT '配置顺序',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '物联配置信息表';
